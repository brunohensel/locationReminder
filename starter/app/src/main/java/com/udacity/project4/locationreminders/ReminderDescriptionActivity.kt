...
class ReminderDescriptionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvReminderTitle.text = reminderDetails.title
        binding.tvReminderDescription.text = reminderDetails.description
        binding.tvReminderLocation.text = reminderDetails.location
